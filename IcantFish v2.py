...
class App(CTk):
    ...
    def build_logging_tab(self, parent):
        ...
        CTkEntry(discord_webhook, width=120, textvariable=discord_webhook_cycle_var).grid(row=3, column=1, padx=12, pady=10, sticky="w")
        ...
        CTkEntry(discord_webhook, width=120, textvariable=discord_webhook_time_var).grid(row=4, column=1, padx=12, pady=10, sticky="w")
        ...
        CTkEntry(discord_webhook, width=120, textvariable=discord_webhook_name_var).grid(row=6, column=1, padx=12, pady=10, sticky="w")
